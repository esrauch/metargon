...
export function drawIcon(ctx, icon, pos, w) {
    switch (icon) {
        case Icon.SPIN:
            spinIcon(ctx, pos, w);
            return;
...
function spinIcon(ctx, pos, w) {
    ...
    */
    ...
    ctx.stroke();
    ctx.beginPath();
    ctx.moveTo(x + cr - tw, y);
    ctx.lineTo(x + cr + tw, y);
    ctx.lineTo(x + cr, y + tw);
    ctx.fill();
    ctx.beginPath();
    ctx.moveTo(x, y - tw + cr);
    ctx.lineTo(x, y + tw + cr);
    ctx.lineTo(x - tw, y + cr);
    ctx.fill();
    ctx.beginPath();
    ctx.moveTo(x - cr - tw, y);
    ctx.lineTo(x - cr + tw, y);
    ...
    ctx.fill();
    ctx.beginPath();
    ctx.moveTo(x, y - cr - tw);
    ctx.lineTo(x, y - cr + tw);
    ctx.lineTo(x + tw, y - cr);
    ctx.fill();
}
