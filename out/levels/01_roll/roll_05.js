...
export class Rolling05 {
    activate() {
        ...
        initWinSensor(new PositionedRect(new Pos(VWIDTH / 2, VHEIGHT - 125), VWIDTH, 250));
        {
            ...
            animationSystem.addAnimation(CyclicMoveAnimation.ofOffset(loseSensor, new Vec(-300, 0), 4));
        }
        {
            ...
            animationSystem.addAnimation(CyclicMoveAnimation.ofOffset(loseSensor, new Vec(200, 0), 4));
        }
        {
        ...
        }
        {
            ...
            animationSystem.addAnimation(CyclicMoveAnimation.ofOffset(loseSensor, new Vec(-80, 0), 10));
        }
        {
            ...
            animationSystem.addAnimation(CyclicMoveAnimation.ofOffset(loseSensor1, new Vec(-300, 0), 2));
            const loseSensor2 = initLoseSensor(PositionedRect.trbl(1550, 350, 1550 + 100, 350 - 150));
            animationSystem.addAnimation(CyclicMoveAnimation.ofOffset(loseSensor2, new Vec(-150, 0), 2.7));
            const loseSensor3 = initLoseSensor(PositionedRect.trbl(1550, 350, 1550 + 100, 350 - 150));
            animationSystem.addAnimation(CyclicMoveAnimation.ofOffset(loseSensor3, new Vec(-500, 0), 3.8));
        }
    }
}
