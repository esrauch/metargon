...
import { initPlayerEntity, initWorldBounds, initControls, initLoseSensor, initStaticBox, initWinSensor, initControl } from "../init_helpers.js";
...
export class Tilt02 {
    activate(): void {
        ...
        }
        {
            ...
            animationSystem.start(
                CyclicMoveAnimation.ofOffset(loseSensor, new Vec(-130, 0), 10));
        }
        {
