    ...
    activate(): void {
        ...
        
        {
            ...
            animationSystem.addAnimation(
                CyclicMoveAnimation.ofOffset(loseSensor, new Vec(-300, 0), 4));
        }
        {
            ...
            animationSystem.addAnimation(
            CyclicMoveAnimation.ofOffset(loseSensor, new Vec(200, 0), 4));
        }
        {
        ...
        }
        {
            ...
            animationSystem.addAnimation(
                CyclicMoveAnimation.ofOffset(loseSensor, new Vec(-80, 0), 10));
        }
        {
