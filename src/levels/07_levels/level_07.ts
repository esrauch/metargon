...
import { initPlayerEntity, initWorldBounds, initControlsWidget, initStaticBox, initWinSensor, initResetButton, initNonRotatingBox, initLoseSensor, initControl } from "../init_helpers.js";
import { Level } from "../level.js";

export class Level07 implements Level {
    activate(): void {
